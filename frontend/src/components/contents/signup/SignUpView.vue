<script setup>
import signupDatas from "@/assets/js/contents/signup/data.js";
import signupMethods from "@/assets/js/contents/signup/methods.js";
</script>
...
<style scoped>
@import "@/assets/css/contents/signup/signup.css";
</style>
