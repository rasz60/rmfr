<script setup>
import settingMethods from "@b-js/contents/setting/methods.js";
import settingDatas from "@b-js/contents/setting/data.js";
</script>
...
<style scoped>
@import "@b-css/contents/setting/setting.css";
</style>
